...
/**
 * Created by Tugce Ayric on 2.04.2018.
 */

public class malzemeSil extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.malzeme_sil);

        listView = (ListView) findViewById(R.id.listview3);
        client = new OkHttpClient();

        dialog3 = new Dialog(malzemeSil.this);
    ...
    public class getir extends AsyncTask {
        ...
        protected void onPostExecute(Object o) {
            ...
            adapter = new stokAdapter(malzemeSil.this, malzemeler, getApplicationContext());
